		  ...
		  <div class="admin-wrap-content" style="padding-right: 35px !important;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				{if $data.id == '19' or $data.id == '20' or $data.id == '2' or $data.id == '21' or $data.id == '55'}
					<div class="subheading"> This page is dynamic. You can only change the Title, URL and meta strings. Content can be edited only within the file itself. ( <a style="opacity: 0.8;" href="{$BASE_URL_ADMIN}pages/">&larr;go back</a> )</div>
				{else}
					<div class="subheading">Write URL in lowercase as a single word (eg. "test-page"). Use WYSIWYG editor to create HTML content of your page or copy content from DOC / PDF. Template file will be generated in the "_tpl/{$THEME}/static" folder. ( <a style="opacity: 0.8;" href="{$BASE_URL_ADMIN}pages/">&larr;go back</a> )</div>
				{/if}
