	...
	<div class="admin-content">
	 <div class="admin-wrap-content">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="subheading" >Permalink = URL. Write as a shortcut or in lowercase as a single word (eg. "UK", or "united-kingdom"). ( <a style="opacity: 0.8;" href="{$BASE_URL_ADMIN}cities/">&larr;go back</a> )</div>
			<br />
		</div>
