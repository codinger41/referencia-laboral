...
<div class="admin-content">
  <div class="admin-wrap-content" >
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb25">
			...
			<div class="subheading">If there is no cron job scheduled, you can remove unnecessary database entries in this section. Everything above 0 is redundant.</div>
		</div>
