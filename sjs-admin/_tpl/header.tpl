...
<body class="flat-green">
	...
	<div class="app-container">
                    ...
                    <ul class="nav navbar-nav navbar-right" >
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                <li class="title">
                                   <a href="{$BASE_URL_ADMIN}translations/">Translations</a>
                                </li>
                                ...
                                <li class="title" style="border-top: solid 1px #e6e6e6;">
                                   <a href="{$BASE_URL_ADMIN}css/">Custom CSS</a>
                                </li>
                            </ul>
                        </li>
 						<li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                <li class="title">
                                 ...
                                 <li class="title" style="border-top: solid 1px #e6e6e6;">
                                   <a href="{$BASE_URL}" target="_blank">Open web</a>
                                </li>
                                <li class="title" style="border-top: solid 1px #e6e6e6;">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="{if $ACTIVE == '3'}active{/if}">
                                <a href="{$BASE_URL_ADMIN}job-applications/">
                                    <i class="fa fa-user-circle fa-lg ml5 mr5" aria-hidden="true"></i><span class="title">Applications</span>
                                </a>
                            </li>
                            ...
                            <li class="{if $ACTIVE == '5'}active{/if}">
                                <a href="{$BASE_URL_ADMIN}cities/list/">
                                    <i class="fa fa-map-marker fa-lg ml5 mr5" aria-hidden="true"></i><span class="title">Locations</span>
                                </a>
                            </li>
                            <li class="{if $ACTIVE == '6'}active{/if}">
                                <a href="{$BASE_URL_ADMIN}categories/">
                                    <i class="fa fa-tasks fa-lg ml5 mr5" aria-hidden="true"></i><span class="title">Categories</span>
                                </a>
                            </li>
                            <li class="{if $ACTIVE == '7'}active{/if}">
                                <a href="{$BASE_URL_ADMIN}types/">
                                    <i class="fa fa-calendar-check-o fa-lg ml5 mr5" aria-hidden="true"></i><span class="title">Types</span>
                                </a>
                            </li>
        ...
        <footer class="app-footer">
            <div class="wrapper">
                <span class="pull-right">SJS &nbsp; {$SJS_VERSION} {if $SJS_PRODUCT == 'free'}&nbsp;&nbsp;<a style="color: #2b8886; font-size: 13px; " href="https://simplejobscript.com/downloads/simplejobscript-complete/" target="_blank">update</a>{/if}&nbsp;&nbsp;<a href="#"><i class="fa fa-long-arrow-up"></i></a></span> &copy; {$SITE_NAME}
            </div>
        </footer>
		{/if}