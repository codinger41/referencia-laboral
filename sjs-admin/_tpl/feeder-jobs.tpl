 ...
 <div class="admin-wrap-content " >
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="alert alert-info fade in main-color">
		    ...
		    All jobs posted are owned by the default administration account, with an employer named "Admin" and a company
		    named "Simplejobscript". You can change the company details to fit your project. Just keep the employer name "Admin".
		</div>
		{if $EMP_MISSING_ERR}
