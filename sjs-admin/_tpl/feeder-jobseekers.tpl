		...
		<div class="alert alert-info fade in main-color">
		    <a href="#" class="close" data-dismiss="alert">&times;</a>
		     <i class="fa fa-info-circle info-fa" aria-hidden="true"></i>&nbsp;
		  	Create and register new candidate profiles. There is no need for any email verification all entries are automatically
		  	published.
		</div>
	</div>
	 ...
	 <form role="form" method="post" action="{$BASE_URL_ADMIN}feeder/candidates" enctype="multipart/form-data" >
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 deskPr100">
				...
				<div class="form-group">
					<textarea placeholder="Jobseeker profile information, education, experience (*)" required maxlength="500" class="form-control" rows="5" id="apply_msg" name="apply_msg"></textarea>
