			...
			<div class="list translations">
				{foreach item=tr_section from=$translations_raw}
					<div class="row {cycle values='even-border, odd'}">
						<div style="float:right;padding:10px"><a href="#" title="Delete this section" class="translation-section-delete" rel="{$tr_section.id}"><i class="fa fa-trash fa-lg blueColor" aria-hidden="true"></i></a></div>
							...
							{foreach item=tr_item from=$tr_section.items}
								<tr>
									...
									<td>
										...
										{/if}
										 &nbsp;<a href="#" title="Delete this item" class="translation-item-delete" rel="{$tr_item.id}"><i class="ml5 fa fa-trash fa-lg blueColor" aria-hidden="true"></i></a>
									</td>
								</tr>
							{/foreach}
							</table>
