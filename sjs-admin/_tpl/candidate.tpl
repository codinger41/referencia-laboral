...
<div class="admin-wrap-content">
	...
	<div class="subheading">By removing applicant employers will no longer see his entry in the CV database. All of the job applications will be removed as well. Before deletion candidate will receive a notification email<a href="/sjs-admin/candidates"><div class="subheading" style="color: #000;opacity: 0.65;">(&larr;go back)</div></a></div>
	</div>
...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
	{if $data.confirmed == '1'}
		<a href="{$BASE_URL_ADMIN}candidate/unconfirm/{$data.id}" title="Unconfirm account">
			<button type="submit" class="btn btn-default btn-primary mbtn" style="margin-top: 25px; background-color: #E74C3C">UNCONFIRM ACCOUNT</button>
		</a>
	{else}
		<a href="{$BASE_URL_ADMIN}candidate/confirm/{$data.id}" title="Confirm account">
			<button type="submit" class="btn btn-default btn-primary mbtn" style="margin-top: 25px; background-color: #E74C3C">CONFIRM ACCOUNT</button>
		</a>
	{/if}
