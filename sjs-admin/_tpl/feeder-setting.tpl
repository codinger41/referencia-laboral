	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-bottom: 20px;">
		...
		<div class="alert alert-info fade in main-color">
		    ...
		    <i class="fa fa-info-circle info-fa" aria-hidden="true"></i>&nbsp;
		  	Set the email address for this section. All the jobs that you post by data feeder will use this address. Therefore enter an email, where you wish
		  	to receive all the job application messages.
		</div>
	</div>
