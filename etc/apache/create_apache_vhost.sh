...
echo "Fully Qualified hostname of your service (eg simplejobscript.com)"
read VHOST_HOSTNAME
echo
fi
...
#read IP_WAN
#echo
echo "What is the full path to the your project?"
...
then
   ...
   echo "Cut and paste the following into your server config"
   echo "===================================================="
