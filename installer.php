...
?>
	...
	<label style="color: #00b386;">Your environment and permissions are set up correctly. Create new database for this project and put your connection details below:</label><br /><br />
	...
	<fieldset style="border: solid 1px #d9d9d9; padding: 10px;">
		App Url: &nbsp;<input style="float: right" type="text" name="url" value="example.com" required /><br /><br />
		Database host: &nbsp;<input style="float: right" type="text" name="host" value="127.0.0.1" required /><br /><br />
		Database port: &nbsp;<input style="float: right" type="text" name="port" value="3306" required /><br /><br />
		Database username: &nbsp;<input style="float: right" name="username" type="text" required /><br /><br />
		Database password: &nbsp;<input style="float: right" name="password" type="password" required /><br /><br />
		Database name (should exist): &nbsp;<input style="float: right" name="db_name" type="text" required /><br /><br />
