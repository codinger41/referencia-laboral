	...
	SimpleJobScript = {
		...
		addProfileSMLink: function() {
			...
			if (links < 4) {
				...
				// generate HTML
				var html = '<div id="sm_fg_' + newVal + '" class="oh">';

				html += '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl0 ml0 mb20">';

				// input
				html += '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pl0 ml0"><div class="form-group">';
				...
				// close
				html += '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pl0 ml0"><div class="form-group">';
				html += '<a id="sm_close_' + newVal + '" href="#" onclick="return SimpleJobScript.removeProfileSMfield(' + newVal + ');"><i class="fa fa-close mt12" aria-hidden="true"></i></a></div>';
				html += '</div></div>';
			...
			if (links == 3) {
				$('#addSMLink').html('').html(SimpleJobScript.I18n.js.limit_reached);
			}
		...
		addExternalLink: function() {
			...
			if (links < 4) {
				...
				// CLOSE
				html += '<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pl0 ml0">';
				html += '<a id="sm_close_' + newVal + '" href="#" onclick="return SimpleJobScript.removeSMentry(' + newVal + ');"><i class="fa fa-close mt12" aria-hidden="true"></i></a></div>';
				html += '</div>';
			...
			if (links == 3) {
				$('#addLink').html('').html(SimpleJobScript.I18n.js.limit_reached);
			}
		...
		IndeedLandingSearch: function(url, p, location, title) {
		...
		IndeedSearch: function(url, p, jobtype, location, city) {
		...
		companyPublicProfileSwitched: function(val) {
 		...
 		cr: function(ver){
			if (ver == 'free') {
				$('#library-loads').html('powered by &nbsp;<a href=\"https://simplejobscript.com/\" target=\"_blank\">SJS</a>');
			} 
		},
		...
		CreateModals: function(app) {
			...
			content += '</div>';
			content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.applied_label + '</span><br /> ' + app.date_formated + '</div>';
			content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.email_label + '</span><br /> ' + app.email + '</div>';
			if (app.phone != '')
				content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.phone_label + '</span><br /><a href=\"tel:' + app.phone + '\">' + app.phone + '</a></div>';
			if (app.website != '')
				content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.website_label + '</span><br /><a href=\"http://' + app.website + '\" target=\"_blank\">' + linkToShow + '</a></div>';

			if (sm_content != '') {
				content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.social_media_label + '</span><br />' + sm_content + '</div>';
			}
			content += '<div class=\"modal-body\"><span class=\"modal-label\">' + SimpleJobScript.I18n.js.application_message + '</span><br /><br /> ' + app.message + '</div>';
			content += '<div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-default btn-warning mbtn\" data-dismiss=\"modal\">' + SimpleJobScript.I18n.js.close + '</button></div></div></div></div>';
