	...
	<div id="forgotten-zone" style="display: none;">
		<form role="form" action="" method="post" style="margin-top: -20px;">
			...
			<div class="form-group">
				...
				<button type="submit_forgotten_pass"  onclick="return SimpleJobScript.passwordRecoveryApplicants();" class="btn btn-default btn-primary mbtn" name="submit" id="submit" required>{$translations.login.forgotten_submit}</button>
