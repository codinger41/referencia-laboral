<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb20">
  <label class="admin-label mt20">{$translations.dashboard_recruiter.statistics_headline}</label>
  ...
  <div class="alert alert-info fade in main-color mt15">
      ...
      {$translations.dashboard_recruiter.statistics_desc}
  </div>
</div>
...
<div class="row-clear">
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 " >
		 <label class="gauge-title">{$conversion_title}</label>
